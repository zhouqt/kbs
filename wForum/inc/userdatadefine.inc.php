...
$groups=array("无门无派");
$shenxiao=array("未知","鼠","牛","虎","兔","龙","蛇","马","羊","猴","鸡","狗","猪");
...
function astro($birthmonth, $birthday)
{
  ...
  switch ($birthmonth)
  {
    case 1:
      if ($birthday>=21)
      {
        ...
        $function_ret="<img src=star/z11.gif alt=水瓶座".$birth.">";
      }
        else
      {

        $function_ret="<img src=star/z10.gif alt=魔羯座".$birth.">";
      } 
    ...
    case 2:
      if ($birthday>=20)
      {
        ...
        $function_ret="<img src=star/z12.gif alt=双鱼座".$birth.">";
      }
        else
      {
    ...
    case 3:
      if ($birthday>=21)
      {
        ...
        $function_ret="<img src=star/z1.gif alt=白羊座".$birth.">";
      }
        else
      {
    ...
    case 4:
      if ($birthday>=21)
      {
        ...
        $function_ret="<img src=star/z2.gif alt=金牛座".$birth.">";
      }
        else
      {
    ...
    case 5:
      if ($birthday>=22)
      {
        ...
        $function_ret="<img src=star/z3.gif alt=双子座".$birth.">";
      }
        else
      {
    ...
    case 6:
      if ($birthday>=22)
      {
        ...
        $function_ret="<img src=star/z4.gif alt=巨蟹座".$birth.">";
      }
        else
      {
    ...
    case 7:
      if ($birthday>=23)
      {
        ...
        $function_ret="<img src=star/z5.gif alt=狮子座".$birth.">";
      }
        else
      {
    ...
    case 8:
      if ($birthday>=24)
      {
        ...
        $function_ret="<img src=star/z6.gif alt=处女座".$birth.">";
      }
        else
      {
    ...
    case 9:
      if ($birthday>=24)
      {
        ...
        $function_ret="<img src=star/z7.gif alt=天秤座".$birth.">";
      }
        else
      {
    ...
    case 10:
      if ($birthday>=24)
      {
        ...
        $function_ret="<img src=star/z8.gif alt=天蝎座".$birth.">";
      }
        else
      {
    ...
    case 11:
      if ($birthday>=23)
      {
        ...
        $function_ret="<img src=star/z9.gif alt=射手座".$birth.">";
      }
        else
      {
