...
$bloodtype=array("","A","B","O","AB","其他");
$religion=array("","佛教", "道教", "基督教","天主教", "回教" , "无神论者", "共产主义者", "其他");
$profession=array("" ,"学生", "财会/金融", "工程师", "顾问", "计算机相关行业", "家庭主妇", "教育/培训",
"客户服务/支持","零售商/手工工人", "退休","无职业","销售/市场/广告","研究和开发","一般管理/监督",
"政府/军队","执行官/高级管理","制造/生产/操作","专业人员","自雇/业主","其他");
$married=array("","未婚","已婚","离异","丧偶");
$graduate=array("","小学","初中","高中","大学","研究生","博士");
$character=array("","多重性格","乐天达观", "成熟稳重","幼稚调皮","温柔体贴","活泼可爱","普普通通","内向害羞",
