...
static void blowfish_encrypt(BlowfishContext * context, word32 xl, word32 xr, word32 * output)
{
    word32 yl;
    word32 yr;
    word32 *S = context->S;
...
static void blowfish_decrypt(BlowfishContext * context, word32 xl, word32 xr, word32 * output)
{
    word32 yl;
    word32 yr;
    word32 *S = context->S;
...
void blowfish_cbc_encrypt(BlowfishContext * ctx, unsigned char *dst, const unsigned char *src, unsigned int len)
{
...
void blowfish_cbc_decrypt(BlowfishContext * ctx, unsigned char *dst, const unsigned char *src, unsigned int len)
{
...
void blowfish_set_key(BlowfishContext * context, const unsigned char *key, short keybytes, int for_encyption)
{
    short i;
    short j;
    short count;
