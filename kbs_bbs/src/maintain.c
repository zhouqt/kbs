        ...
        if (lookupuser) {
            if (strstr(str, "ÈÃ") && strstr(str, "Í¨¹ýÉí·ÝÈ·ÈÏ")) {
                ...
                *(ptr + strlen("µÄÈ¨ÏÞ")) = 0;
                ...
                fprintf(se, "\n"
                        "\033[1m\033[33mb\033[m»ù±¾È¨Á¦ \033[1m\033[33mT\033[m½øÁÄÌìÊÒ \033[1m\033[33mC\033[mºô½ÐÁÄÌì \033[1m\033[33mP\033[m·¢ÎÄÕÂ \033[1m\033[33mR\033[m×ÊÁÏÕýÈ· \033[1m\033[33mp\033[m¼àÀí \033[1m\033[33m#\033[m¿ÉÒþÉí \033[1m\033[33m@\033[m¿É¼ûÒþÉí\n"
...
int m_editbrd()
{
    ...
    prints("ÏÞÖÆ %s È¨Á¦: %s", (fh.level & PERM_POSTMASK) ? "POST" : "READ", (fh.level & ~PERM_POSTMASK) == 0 ? "²»ÉèÏÞ" : "ÓÐÉèÏÞ");
    getdata(10, 0, "ÊÇ·ñ¸ü¸ÄÒÔÉÏ×ÊÑ¶? (Yes or No) [N]: ", genbuf, 4, DOECHO, NULL, true);
    if (*genbuf == 'y' || *genbuf == 'Y') {
        move(9, 0);
        prints("Ö±½Ó°´ <Return> ²»ÐÞ¸Ä´ËÀ¸×ÊÑ¶\n");
      enterbname:
        getdata(10, 0, "ÐÂÌÖÂÛÇøÃû³Æ: ", genbuf, 18, DOECHO, NULL, true);
        if (*genbuf != 0) {
            ...
            if (a_mv >= 1) {
                ...
                if (strcmp(oldpath, newpath) || a_mv != 2) {
                    if (group != NULL) {
                        ...
                        /*
                         * add_grp() »áÔÚ .Search ÖÐ¼ÓÈëÒ»Ìõ¼ÇÂ¼ 
                         */
                        ...
                        /*
                         * FIXME: ÕâÀïÂß¼­ÉÏÓÐÎÊÌâ£¬Ã÷ÌìÔÙ´¦ÀíÁË 
                         */
                        /*
                         * ÒòÎª del_grp() ÐèÒªËÑË÷ .Search ÎÄ¼þ£¬
                         * * µ«´ËÊ± .Search ÖÐÒÑ¾­Ã»ÓÐ fh.filename ÁË 
                         */
