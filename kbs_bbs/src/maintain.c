...
enterbname:
        ...
        getdata(14, 0, "ÊÇ·ñÒÆ¶¯¾«»ªÇøµÄÎ»ÖÃ (Y/N)? [N]: ", genbuf, 4, DOECHO, NULL, YEA);
        if (*genbuf == 'Y' || *genbuf == 'y')
            a_mv = 2;
        else
            a_mv = 0;
        getdata(15, 0, "ÊÇ·ñ¸ü¸Ä´æÈ¡È¨ÏŞ (Y/N)? [N]: ", genbuf, 4, DOECHO, NULL, YEA);
        if (*genbuf == 'Y' || *genbuf == 'y')
        {
            char            ans[5];
        ...
        {
            getdata(16, 0, "È·¶¨Òª¸ü¸ÄÂğ? (Y/N) [N]: ", genbuf, 4, DOECHO, NULL, YEA);
        }
        if (*genbuf == 'Y' || *genbuf == 'y')
        {
            {
