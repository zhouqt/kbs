...
int check_systempasswd()
{
    ...
    if ((pass = fopen("etc/systempassword", "r")) != NULL)
    {
        ...
        getdata(1, 0, "ÇëÊäÈëÏµÍ³ÃÜÂë: ", passbuf, 19, NOECHO, NULL, YEA);
...
int setsystempasswd()
{
    ...
    if (!check_systempasswd())
        return;
    getdata(2, 0, "ÇëÊäÈëĞÂµÄÏµÍ³ÃÜÂë: ", passbuf, 19, NOECHO, NULL, YEA);
    getdata(3, 0, "È·ÈÏĞÂµÄÏµÍ³ÃÜÂë: ", prepass, 19, NOECHO, NULL, YEA);
