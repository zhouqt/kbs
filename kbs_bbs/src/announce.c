...
int nomsg; /* fancyrabbit Oct 12 2007, nomsg == true ´Ó²»³öÏÖÌáÊ¾¸ÄÎª(²»³öÏÖÌáÊ¾ && ²»¼Æ bmlog) */
    ...
    if (ann_get_path(key, buf, sizeof(buf)) == 0) {
        ...
        */
        ...
        if (a_savenames(&pm) == 0) {
             ...
             */
            if (ret==0 && !nomsg) /* b4 ²Ù×÷²»ÔÙÖØ¸´¼ÆËã bmlog, ×¢Òâ²»ÒªÎóÉË, fancyrabbit Oct 12 2007 */
                    ...
                    do {
                        ...
                        if (checkreadonly(bname)) {
                            ...
                            if (HAS_PERM(getCurrentUser(), PERM_ADMIN)) {
                                getdata(4, 5, "\033[1;33mÄ¿µÄ°æÃæÄ¿Ç°Îª\033[1;31mÖ»¶Á\033[1;33mÄ£Ê½, ÄúÈ·¶¨ÒªÇ¿ÖÆ×ªÔØ? [y/N]: \033[m", ans, 2, DOECHO, NULL, true);
                                if (toupper(ans[0]) != 'Y') {
                                    break;
                                }
                                move(4, 0); clrtoeol();
                        ...
                        switch (ret) {
                            case 1 :
                                ...
                                break;
                            case -1:
                                prints("\033[1;33m%s\033[0;33m<Enter>\033[m", "×ªÔØ¹ý³ÌÖÐ·¢Éú´íÎó ...");
                                break;
                            case -2:
                                ...
                                move(t_lines - 1, 0);
                                prints("%s", "                              \x1b[33mÇë°´ ¡ô\x1b[36mEnter\x1b[33m¡ô ¼ÌÐø\x1b[m");
                                break;
                        }
                        WAIT_RETURN;
                    } while (0);
