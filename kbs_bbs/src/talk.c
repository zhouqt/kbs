    ...
    if (uinfo.mode != LUSERS && uinfo.mode != LAUSERS && uinfo.mode != FRIEND && uinfo.mode != GMENU) {
        ...
        if ((genbuf[0]) && seecount) {
            if (DEFINE(currentuser, DEF_HIGHCOLOR))
                prints("\x1b[m\x1b[44mÁÄÌì[\x1b[1;32mt\x1b[m\x1b[0;44m] ¼ÄÐÅ[\x1b[1;32mm\x1b[m\x1b[0;44m] ËÍÑ¶Ï¢[\x1b[1;32ms\x1b[m\x1b[0;44m] ¼Ó,¼õÅóÓÑ[\x1b[1;32mo\x1b[m\x1b[0;44m,\x1b[1;32md\x1b[m\x1b[0;44m] ÆäËü¼ü¼ÌÐø                            \x1b[m");
            else
                prints("\x1b[44mÁÄÌì[t] ¼ÄÐÅ[m] ËÍÑ¶Ï¢[s] ¼Ó,¼õÅóÓÑ[o,d] ÆäËü¼ü¼ÌÐø                            \x1b[m");
        }
        else {
            if (DEFINE(currentuser, DEF_HIGHCOLOR))
                prints("\x1b[m\x1b[44m        ¼ÄÐÅ[\x1b[1;32mm\x1b[m\x1b[0;44m]           ¼Ó,¼õÅóÓÑ[\x1b[1;32mo\x1b[m\x1b[0;44m,\x1b[1;32md\x1b[m\x1b[0;44m] ÆäËü¼ü¼ÌÐø                            \x1b[m");
            else
                prints("\x1b[44m        ¼ÄÐÅ[m]           ¼Ó,¼õÅóÓÑ[o,d] ÆäËü¼ü¼ÌÐø                            \x1b[m");
        }
        ch = igetkey();
        switch(toupper(ch)) {
            case 'T':
