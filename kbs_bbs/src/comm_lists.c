...
int d_board(), m_editbrd(), toooooooooooooold_m_editbrd(), m_trace(), m_vote(), wall();
/*
int m_mclean();*/
...
static const struct scommandlist sysconf_cmdlist[] = {
    ...
    {"NewBoard", m_newbrd},
    {"EditBoard", m_editbrd},
    {"OldEditBoard", toooooooooooooold_m_editbrd},
    {"DelBoard", d_board},
    {"SetTrace", m_trace},
    {"Xlevel", x_deny},
...
int exec_mbem(char *s)
{
    ...
    {      
        ...
        {         
	    char* error;
            if((func=(void (*func)())(dlsym(hdll,c ? c : "mod_main")))!=NULL)
            func();         
	    else
