...
void a_edits()
{
	...
	"f_fill.real", "f_fill.chinese", "f_fill.toomany", "f_fill.proxy", "smail", "f_fill", "../.badname", "../.badIP", "../.badword", "sysconf.ini", "www_menu.js", "../0Announce/hotinfo", "forbm",
	    "forcloak",
	...
	"×¢²áµ¥Ê§°Üµµ(¾Ó×¡µØÖ·)", "×¢²áµ¥Ê§°Üµµ(ÁªÂçµç»°)", "×¢²áµ¥Ê§°Üµµ(ÕæÊµ×ÊÁÏ)", "×¢²áµ¥Ê§°Üµµ(ÖĞÎÄÌîĞ´)", "×¢²áµ¥Ê§°Üµµ(¹ı¶àµÄID)", "×¢²áµ¥Ê§°Üµµ(²»ÄÜ´©Ëó×¢²á)", "Éí·İÈ·ÈÏÍê³Éµµ        ",
	    "Éí·İÈ·ÈÏÊ§°Üµµ",
	"²»¿É×¢²áµÄ ID         ", "²»¿ÉµÇÂ¼µÄ IP", "ÏµÍ³×Ô¶¯¹ıÂËµÄ´ÊÓï    ", "sysconf.ini", "WWWÖ÷²Ëµ¥             ", "½üÆÚÈÈµã", "¸øĞÂÈÎ°æÖ÷µÄĞÅ        ", "¸øÒşÉíÓÃ»§µÄĞÅ", "¸ø³¤ÆÚÓÃ»§µÄĞÅ        ",
	    "×ªĞÅ°æºÍĞÂÎÅ×é¶ÔÓ¦",
	"·â½ûÀíÓÉÁĞ±í", NULL
    };
