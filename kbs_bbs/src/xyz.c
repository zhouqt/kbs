...
x_level()
{
    ...
    if (newlevel == lookupuser->userlevel)
        ...
        if ((lookupuser->userlevel & PERM_BOARDS ) && flag==0 )
            mail_file("etc/forbm",lookupuser->userid,"ÐÂÈÎ°åÖ÷±Ø¶Á");
        /* Bigman 2000.1.5 ÐÞ¸ÄÈ¨ÏÞ×Ô¶¯·¢ÐÅ */
        if ((lookupuser->userlevel & PERM_CLOAK ) && flag1==0 )
            mail_file("etc/forcloak",lookupuser->userid,"Åú×¼ÄúµÄÒþÉíÉêÇë");
...
XCheckLevel() /* Leeward 98.06.05 */
{
    ...
    clear();
    move(0,0) ;
    prints("ÁÐÊ¾¾ßÓÐÌØ¶¨È¨ÏÞµÄÓÃ»§µÄ×ÊÁÏ\n") ;
    clrtoeol() ;
    move(2,0);
...
a_edits()
{
    ...
    char *explain_file[]={"Welcome","¹«ÓÃ±¸ÍüÂ¼","½øÕ¾»¶Ó­µµ","»î¶¯¿´°æ","ÀëÕ¾»­Ãæ", "menu.ini","Éí·ÝÈ·ÈÏµµ","×¢²áµ¥Íê³Éµµ","×¢²áµ¥Ê§°Üµµ(ÕæÊµÐÕÃû)","×¢²áµ¥Ê§°Üµµ(·þÎñµ¥Î»)","×¢²áµ¥Ê§°Üµµ(¾Ó×¡µØÖ·)","×¢²áµ¥Ê§°Üµµ(ÁªÂçµç»°)","×¢²áµ¥Ê§°Üµµ(ÕæÊµ×ÊÁÏ)","×¢²áµ¥Ê§°Üµµ(ÖÐÎÄÌîÐ´)","×¢²áµ¥Ê§°Üµµ(¹ý¶àµÄID)","×¢²áµ¥Ê§°Üµµ(Mail Reply)" ,"Éí·ÝÈ·ÈÏÍê³Éµµ        ","Éí·ÝÈ·ÈÏÊ§°Üµµ","²»¿É×¢²áµÄ ID         ", "²»¿ÉµÇÂ¼µÄ IP", "ÏµÍ³×Ô¶¯¹ýÂËµÄ´ÊÓï", "sysconf.ini", "WWWÖ÷²Ëµ¥",  "½üÆÚÈÈµã",NULL};
#else
char *explain_file[]={"Welcome","¹«ÓÃ±¸ÍüÂ¼","½øÕ¾»¶Ó­µµ","»î¶¯¿´°æ","ÀëÕ¾»­Ãæ", "menu.ini","Éí·ÝÈ·ÈÏµµ","×¢²áµ¥Íê³Éµµ","×¢²áµ¥Ê§°Üµµ(ÕæÊµÐÕÃû)","×¢²áµ¥Ê§°Üµµ(·þÎñµ¥Î»)","×¢²áµ¥Ê§°Üµµ(¾Ó×¡µØÖ·)","×¢²áµ¥Ê§°Üµµ(ÁªÂçµç»°)","×¢²áµ¥Ê§°Üµµ(ÕæÊµ×ÊÁÏ)","×¢²áµ¥Ê§°Üµµ(ÖÐÎÄÌîÐ´)","×¢²áµ¥Ê§°Üµµ(¹ý¶àµÄID)","×¢²áµ¥Ê§°Üµµ(Mail Reply)" ,"Éí·ÝÈ·ÈÏÍê³Éµµ        ","Éí·ÝÈ·ÈÏÊ§°Üµµ","²»¿É×¢²áµÄ ID         ", "²»¿ÉµÇÂ¼µÄ IP", "ÏµÍ³×Ô¶¯¹ýÂËµÄ´ÊÓï£¨[1m[31m´Ëµµ°¸Ä¿Ç°ÎÞÐ§£¬²»±ØÉè¶¨»òÐÞ¸Ä[m£©", "sysconf.ini", "WWWÖ÷²Ëµ¥", "½üÆÚÈÈµã",NULL};
#endif
    ...
    getdata(num,0,"ÄãÒª±àÐÞÄÄÒ»ÏîÏµÍ³µµ°¸: ",ans,3,DOECHO,NULL,YEA);
    ch=atoi(ans);
