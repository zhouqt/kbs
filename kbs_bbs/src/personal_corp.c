...
static int pc_dir_title(struct _select_def *conf)
{
	...
	if( pc_dirmode != 2 )
		...
		prints("ÍË³ö[[1;32mq[m] Ôö¼Ó[[1;32ma[m] É¾³ý[[1;32md[m] ÐÞ¸Ä[[1;32me[m] ¿½±´[[1;32mc[m] Õ³Ìù[[1;32mp[m] ÐÞ¸ÄºÃÓÑ[[1;32mo[m] µ¼ÈëºÃÓÑ[[1;32mi[m]");
	move(2,0);
