...
static int pc_dir_title(struct _select_def *conf)
{
	...
	if( pc_dirmode != 2 )
		...
		prints("退出[\033[1;32mq\033[m] 增加[\033[1;32ma\033[m] 删除[\033[1;32md\033[m] 修改[\033[1;32me\033[m] 拷贝[\033[1;32mc\033[m] 粘贴[\033[1;32mp\033[m] 修改好友[\033[1;32mo\033[m] 导入好友[\033[1;32mi\033[m]");
	move(2,0);
...
static int pc_dir_show(struct _select_def *conf, int i)
{
	...
	char newts[20];
	prints(" %-3d %s %-38s %-3d %-3d %-12s", i, pc_n[i-conf->page_pos].type==0?"[文章]":"\033[1;33m[目录]\033[m",pc_n[i-conf->page_pos].subject,pc_n[i-conf->page_pos].commentcount, pc_n[i-conf->page_pos].visitcount,tt2timestamp(pc_n[i-conf->page_pos].created,newts));
