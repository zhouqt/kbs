...
//    set_alarm(0, 0, NULL, NULL);
    ...
    while(1) {
        ...
        good_move(23,0);
        if(!all)
            prints("[1;44;32mÑ¶Ï¢ä¯ÀÀÆ÷   ±£Áô<[37mr[32m> Çå³ý<[37mc[32m> ¼Ä»ØÐÅÏä<[37mm[32m> ·¢Ñ¶ÈË<[37mi[32m> Ñ¶Ï¢ÄÚÈÝ<[37ms[32m>        Ê£Óà:%3d ", count-i);
        else
            prints("[1;44;32mÑ¶Ï¢ä¯ÀÀÆ÷   ±£Áô<[37mr[32m> Çå³ý<[37mc[32m> ¼Ä»ØÐÅÏä<[37mm[32m> ·¢Ñ¶ÈË<[37mi[32m> Ñ¶Ï¢ÄÚÈÝ<[37ms[32m> È«²¿<[37ma[32m>     %3d ", count-i);
        refresh();
reenter:
        ch = igetkey();
        switch(ch) {
