...
struct fileheader *ent ;
{
    ...
    */
    ...
    if((HAS_PERM(PERM_OBOARDS)||(chk_currBM(currBM))) && ent->accessed[1] & FILE_MARKED) /* Èç¹ûÎÄ¼ş±»mark delete×¡ÁË£¬ÏÔÊ¾X*/
    {
        type = 'X';
    }
...
char *direct ;
{
    ...
    getdata(1,0,"É¾³ıÄ£Ê½ [0]ÆÕÍ¨É¾³ı [1]Ç¿ÖÆÉ¾³ı(±»markµÄÎÄÕÂÒ»ÆğÉ¾) (0): ",del_mode,10,DOECHO,NULL,YEA) ;
