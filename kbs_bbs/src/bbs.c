...
/* Add by SmallPig */
int
post_cross(char islocal,int mode)    /* (×Ô¶¯Éú³ÉÎÄ¼şÃû) ×ªÌù»ò×Ô¶¯·¢ĞÅ */
{
...
/*    strcpy(quote_board,currboard);*/
    getcross( filepath ,quote_file, currentuser, in_mail,quote_board,quote_title,Anony,mode,currboard); /*¸ù¾İfnameÍê³É ÎÄ¼ş¸´ÖÆ */
