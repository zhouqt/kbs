...
post_article()                         /*ÓÃ»§ POST ÎÄÕÂ */
{
	...
	*/
    ...
    while(1) /* ·¢±íÇ°ÐÞ¸Ä²ÎÊý£¬ ¿ÉÒÔ¿¼ÂÇÌí¼Ó'ÏÔÊ¾Ç©Ãûµµ' */
    {
        ...
        sprintf(buf2,"Çë°´ [1;32m0[m~[1;32m%d V[m Ñ¡/¿´Ç©Ãûµµ%s£¬[1;32mT[m ¸Ä±êÌâ£¬%s[1;32mEnter[m ½ÓÊÜËùÓÐÉè¶¨: ",numofsig,(replymode) ? "£¬[1;32mS/Y[m/[1;32mN[m/[1;32mR[m/[1;32mA[m ¸ÄÒýÑÔÄ£Ê½" : "",(anonyboard)?"[1;32mM[m ÄäÃû£¬":"");
