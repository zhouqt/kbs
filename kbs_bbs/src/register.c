...
void check_register_info()
{
    ...
    if (strchr(curruserdata.email, '@') == NULL) {
        ...
        prints("    ´¦ÓÚĞÂÊÖÉÏÂ·ÆÚ¼ä, ²»ÄÜ×¢²á³ÉÎªºÏ·¨" NAME_USER_SHORT "£¬ÇëËÄ´¦²Î¹ÛÑ§Ï°£¬ÍÆ¼öÔÄ¶ÁBBSHELP °æ£¬Ñ§Ï°±¾Õ¾Ê¹ÓÃ·½·¨ºÍ¸÷ÖÖÀñÒÇ¡£\n");
        prints("\n " REGISTER_WAIT_TIME_NAME "ºó, Äú¾Í¿ÉÒÔ\033[33;1mÌîĞ´×¢²áµ¥\033[mÁË£¬×¢²áµ¥Í¨¹ıÕ¾ÎñÈÏÖ¤ÒÔºó£¬Äú¾ÍÓµÓĞ±¾Õ¾ºÏ·¨ÓÃ»§µÄ»ù±¾È¨ÏŞ¡£×¢²áµ¥ÌîĞ´Â·¾¶ÈçÏÂ: \n\n");
        prints("I) ¸öÈË¹¤¾ßÏä --> F) ÌîĞ´×¢²áµ¥\n\n");
        //prints("    " NAME_SYSOP_GROUP "»á¾¡¿ì¼ì²é²¢È·ÈÏÄãµÄ×¢²áµ¥¡£\n\n");
        /* Leeward adds below 98.04.26 */
        prints("[1m[33mÈç¹ûÄúÒÑ¾­Í¨¹ı×¢²á£¬³ÉÎªºÏ·¨" NAME_USER_SHORT "£¬È´ÒÀÈ»¿´µ½±¾ĞÅÏ¢£¬ÄÇ¿ÉÄÜÊÇÓÉÓÚÄúÃ»ÓĞÔÚ¡®¸öÈË¹¤¾ßÏä¡¯ÄÚÉè¶¨¡®µç×ÓÓÊ¼şĞÅÏä¡¯¡£[m\n");
		prints("\nI) ¸öÈË¹¤¾ßÏä --> I) Éè¶¨¸öÈË×ÊÁÏ\n");
		prints("\nÈç¹ûÄãÊµÔÚÃ»ÓĞÈÎºÎ¿ÉÓÃµÄ'µç×ÓÓÊ¼şĞÅÏä'¿ÉÒÔÉè¶¨£¬ÓÖ²»Ô¸Òâ¿´µ½±¾ĞÅÏ¢£¬¿ÉÒÔÊ¹ÓÃ%s.bbs@%s½øĞĞÉè¶¨¡£\n
	 		\033[33;1m×¢Òâ: ÉÏÃæµÄ×ÓÓÊ¼şĞÅÏä²»ÄÜ½ÓÊÕµç×ÓÓÊ¼ş£¬½öÓÃÀ´Ê¹ÏµÍ³²»ÔÙÏÔÊ¾±¾ĞÅÏ¢¡£\033[m", currentuser->userid, NAME_BBS_ENGLISH);
        pressreturn();
    }
#ifdef HAVE_BIRTHDAY
    ...
    if (!(currentuser->userlevel & PERM_LOGINOK)) {
        ...
        if (!invalid_realmail(currentuser->userid, curruserdata.realemail, STRLEN - 16)) {
            ...
            */
            ...
            prints("Çëµ½[33;1m¸öÈË¹¤¾ßÏä[m_ÏêÏ¸ÕæÊµµØÌîĞ´[32m ×¢²áµ¥ [m");
