...
#define NO_GUEST		1	/* 不允许guest登陆*/
#define NO_CANCEL		1	/* 转信不接受cancel信件*/

#define KissU			1	/* KissU专用代码,呵呵，加了一些模仿FB2k显示的代码*/
#define SMTH			1
#define FILTER			1
/* 
...
#define LIFE_DAY_USER		365
#define LIFE_DAY_YEAR          365
#define LIFE_DAY_LONG		666
#define LIFE_DAY_SYSOP		365
...
#endif
#define MAIL_BBSDOMAIN      "bbs.vmails.net"
#define MAIL_MAILSERVER     "166.111.204.32:25"

#define NAME_BBS_ENGLISH	"KissU"
#define	NAME_BBS_CHINESE	"KissU"
#define NAME_BBS_NICK		"BBS 站"

#define BBS_FULL_NAME "KissU_BBS站"

#define FOOTER_MOVIE		"欢  迎  投  稿"
/*#define ISSUE_LOGIN		"本站使用曙光公司曙光天演服务器"*/
#define ISSUE_LOGIN		"x86 PC  KissU指定服务器"
#define ISSUE_LOGOUT		"还是走了罗"

#define NAME_USER_SHORT		"用户"
#define NAME_USER_LONG		"KissU用户"
#define NAME_SYSOP		"System Operator"
#define NAME_BM			"版主"
#define NAME_POLICE		"警察"
#define	NAME_SYSOP_GROUP	"站务组"
#define NAME_ANONYMOUS		"我爱KissU!"
