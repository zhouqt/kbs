...
<td><a href=/cgi-bin/bbs/bbsmailcon?file=<?php echo $maildata[$i]["FILENAME"];?>&dir=<?php echo $mail_path;?>&num=<?php echo $i;?>&title=<?php echo $mail_title;?>><?php echo htmlspecialchars($maildata[$i]["TITLE"]);?></a>
</tr>
<?php
		}
	}
