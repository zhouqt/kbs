...
int has_read_perm(struct userec *user, char *board) {  
	int x;	/* °æÃæ²»´æÔÚ·µ»Ø0, pºÍz°æÃæ·µ»Ø1, ÓÐÈ¨ÏÞ°æÃæ·µ»Ø1. */
...
/* WWW GUESTÕâÑù×öÓÐ¸öÍ¬²½ÎÊÌâ£¬¾ÍÊÇµ±±»Çå³ýÒ»¸ö
  GUESTµÄÊ±ºòÈç¹ûÕýºÃÕâ¸öguestË¢ÐÂÁË£¬ÄÇÃ´»áÖØÐ´Êý¾Ý½á¹¹
  ËùÒÔ£¬Òª×¢Òâ³ýÁËkeyÖ®ÍâµÄÊý¾ÝÈç¹ûÒª±ä¶¯£¬±ØÐë±£Ö¤
  ÔÚÕâÖÖÇé¿öÏÂ²»»áÂß¼­»ìÂÒ¡£freshtimeÒòÎª¼´Ê¹±»´íÎóµÄ
  client¸üÐÂÁË£¬Îó²îÔÚÃë¼¶£¬¶øÇÒÒ²²»»áÔì³ÉÓÃ»§ÎÊÌâ£¬ËùÒÔ
  ²»»á³ö´í¡£µ«ÊÇÈç¹ûÐèÒª¸üÐÂkey£¬ÄÇÃ´¾ÍÓÐ¿ÉÄÜµ¼ÖÂÏÂÒ»¸ö
...
#define MAX_WWW_MAP_ITEM MAX_WWW_GUEST>>5  /* ³ýÒÔ32 */
#define MAX_WWW_GUEST_IDLE_TIME 3600 /* www guest·¢´ôÊ±¼äÉèÎª1Ð¡Ê±*/
