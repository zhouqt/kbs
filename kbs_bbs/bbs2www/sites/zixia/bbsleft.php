...
<tr>
	<td>
		...
		<tr>
			...
			<span style="font: bold 10pt 'Comic Sans MS',Arial;">&nbsp;BBS.<span style="color:hotpink">ZIXIA</span>.NET</span>
			</td>
		</tr>
<?php
		if($currentuser["userid"]=="guest")
...
?>
		...
		<tr>
			<td><img src="/images/open.gif" border="0"></td>
			<td><a href="telnet:bbs.zixia.net"><img src="<?php echo $img_subdir; ?>m6.gif" border="0" alt="telnet登录" align="absmiddle"> Telnet登录</a>
		</tr>
<?php
