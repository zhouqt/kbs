...
int main()
{
    ...
    if (pid > 0) {
        if (kill(pid, 0) != 0) {
            printf("<script>top.location='about:ÄúÒÑ¾­¶ÏÏß»òÒÑÓÐ1¸ö´°¿Ú½øÈëÁÄÌìÊÒÁË.'</script>");
            exit(0);
        }
    }
    if (!strcmp(t, "frm"))
...
int frame_input(int pid)
{
    printf(" <script>\n"
           ...
           /*"        <option value=\"//hehe\">ºÇºÇµÄÉµÐ¦</option>\n" */
           ...
           "	<option value=\"//luck\">ÕæÐÒÔË°¡</option>\n"
           ...
           "	<option>±¾" CHAT_ROOM_NAME "ÓÐË­</option>\n"
           "	<option>¿´ÓÐË­ÔÚÏß</option>\n"
           "	<option>¶ªÐ¡Ö½Ìõ</option>\n"
           "	<option>¸ÄÁÄÌì´úºÅ</option>\n"
           "	<option>ÌùÍ¼Æ¬</option>\n"
           "	<option>Çå³ýÆÁÄ»</option>\n"
           "	<option>±³¾°·´É«</option>\n"
