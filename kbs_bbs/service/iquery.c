...
ÔÚË®Ä¾Çå»ªbbsÏµÍ³ÉÏÔËÐÐ

±¾ÓÎÏ·ÊÇ×ÔÓÉÈí¼þ£¬ÇëËæÒâ¸´ÖÆÒÆÖ²
ÇëÔÚÐÞ¸ÄºóµÄÎÄ¼þÍ·²¿±£Áô°æÈ¨ÐÅÏ¢
******************************************************/
...
int get_word()
{
    ...
    prints("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-");
    move(8, 0);
    prints("    µçÓ°Ó°ÆÀ                  movie ÎÞ¼äµÀ");
    move(9, 0);
    prints("    Á÷ÐÐÀÖ¸è´Ê                popmusic ÎÒ»³ÄîÓÐÒ»ÄêµÄÏÄÌì");
    move(10, 0);
    prints("    ÐÂÎÅÒªµã                  news ¿ÆË÷ÎÖ");
    move(11, 0);
    prints("    ÎäÏÀÐ¡Ëµ                  emprise ´óÌÆÐÐïÚ");
    move(12, 0);
    prints("    Ê³ÎïÊ³Æ×                  food ÌÇ´×ÅÅ¹Ç");
    move(13, 0);
    prints("    ÓéÀÖÒªÎÅ                  estar ²Ì×¿åû ÖÓÐÀÍ©");
    move(14, 0);
    prints("    °²È«¼¼Êõ                  Ê¹ÓÃsoftice");
    move(15, 0);
    prints("    µçÄÔÓ²¼þ                  Òº¾§ÏÔÊ¾Æ÷");
    move(16, 0);
    prints("    ÓÎÏ·¹¦ÂÔ                  palsword Ö§Ïß");
    move(17, 0);
    prints("    ±à³ÌËã·¨                  Îå×ÓÆå Ëã·¨");
    move(18, 0);
    prints("    ÓÄÄ¬Ð¦»°                  joke Å¼ºÍÅ¼mm");
    move(19, 0);
