...
static int room_list_refresh(struct _select_def *conf)
{
    clear();
    docmdtitle("[”Œœ∑ “—°µ•]",
              "  ÕÀ≥ˆ[\x1b[1;32m°˚\x1b[0;37m,\x1b[1;32me\x1b[0;37m] Ω¯»Î[\x1b[1;32mEnter\x1b[0;37m] —°‘Ò[\x1b[1;32m°¸\x1b[0;37m,\x1b[1;32m°˝\x1b[0;37m] ÃÌº”[\x1b[1;32ma\x1b[0;37m] º”»Î[\x1b[1;32mJ\x1b[0;37m] \x1b[m      ◊˜’ﬂ: \x1b[31mbad@smth.org\x1b[m");
    move(2, 0);
...
static int room_list_show(struct _select_def *conf, int i)
{
    ...
    if(j!=-1) {
        r=rooms+j;
        prints("  %3d  %-14s %-12s %3d  %3d  %2s%2s%2s %-36s", i, r->name, r->creator, r->people, r->maxpeople, (r->flag&ROOM_LOCKED)?"°Ò":"", (r->flag&ROOM_SECRET)?"°Ò":"", (!(r->flag&ROOM_DENYSPEC))?"°Ò":"", r->title);
    }
    return SHOW_CONTINUE;
}
