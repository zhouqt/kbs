...
int showout()
{
    ...
    sprintf(foo, "%s\n", TOPSTR);
    fputs(foo, fp);
    sprintf(foo, "\033[1;30;4%dm＆！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！＆\033[m", COLOR);
    fprintf(fp, "%s\n", foo);
...
/*             if(i%3!=0)
        ...
        if (i % 3 == 0) {
            sprintf(foo, "\033[1;3%d;4%dm＆！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！＆\033[m", COLOR, COLOR);
            fprintf(fp, "%s\n", foo);
        }
    ...
    int port;
{
    ...
    gopher_position = 0;
    sprintf(TOPSTR, "\033[4%dm                            \033[1;3%dm‐\033[37m嶄刹芙軸扮仟療烏擬\033[3%dm／\033[m\033[4%dm                            \033[m", COLOR, COLOR, COLOR, COLOR);
    newitem = (GOPHER *) malloc(sizeof(GOPHER));
