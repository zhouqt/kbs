...
sh(int n)
{
    ...
    oldn = n;
    if (strcmp(host2[n], "般若波羅密") == 0) {  //判断自定义站点
        printf("\033[22;3H\033[1;37m使用方法: 按回车后输入ip。\033[1;33m\033[22;32H\033[1;37m 站名: \033[1;33m自定义站点              \r\n");
        printf("\033[1;37m\033[23;3H连往: \033[1;33m__________                   \033[21;1H");
    } else {
        printf("\033[22;3H\033[1;37m单位: \033[1;33m%s                   \033[22;32H\033[1;37m 站名: \033[1;33m%s              \r\n", host1[n], host2[n]);
        printf("\033[1;37m\033[23;3H连往: \033[1;33m%s                   \033[21;1H", ip[n]);
    }
    locate(n);
...
show_all()
{
    ...
    printf("\033[1H\033[2J\033[m");
    printf("┏━━━━━━━━━━━━━━━\033[1;35m 月  光  宝  盒 \033[m━━━━━━━━━━━━━━━┓\r\n");
    for (n = 1; n < 22; n++)
        printf("┃                                                                            ┃\r\n");
    printf("┃                                                               \033[1;36m按\033[1;33mCtrl+C\033[1;36m退出\033[m ┃\r\n");
    printf("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
    printf("\033[21;3H───\033[1;36m般若波羅密\033[m───────\033[1;36m般-若-波-羅-蜜~~\033[m───────\033[1;36m般若波羅密\033[m───");
    //printf("\033[21;3H\033[1;36m般若波羅密般若波羅密般若波羅密般若波羅密般若波羅密般若波羅密般若波羅密般若波\033[m");
...
bbsnet(int n)
{
    ...
    printf("\033[1H\033[2J\033[1;32mo 连往: %s (%s)\r\n", host2[n], ip[n]);
    printf("%s\r\n\r\n\033[m", "o 连不上时请稍候，30 秒后将自动退出");
    fflush(stdout);
...
proc(char *hostname, char *server, int port)
{
    ...
    if ((tmpsin.sin_addr.s_addr & 0xff00) == (blah.sin_addr.s_addr & 0xff00)) {
        printf("\n\n\n\033[1;31m拜托~ 月光宝盒怎么说也是宝物，您能直接去的地方还是直接去吧... :P\033[m\n\n\n\n\n");
        fflush(stdout);
        sleep(3);
        return;
    }
