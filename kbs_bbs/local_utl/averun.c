...
int draw_pic()
{
    ...
    FILE *fp;
    int max = 0, cr = 0, tm, i, item, j, aver;
    int pic[24];
    char buf[80];
    time_t now;
    ...
    time(&now);
    fprintf(fp, "\033[1;36m    └——\033[37m中正资工四百年来第一站负载人数统计\033[36m—");
    ...
    fprintf(fp, "                         \033[1;36m    1 \033[32m□\033[36m = \033[37m%3d     \033[36m 平均上站人数：\033[37m%3d\033[m\n", item, aver);
    fclose(fp);
}
...
{
    FILE *fp;
    char file[80], buf[100], start[10], end[10], *p;
    int i, tmp, ave, time;
